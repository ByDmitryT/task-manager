...
import ru.titov.taskmanagerserver.dto.response.TokenResponse;
import ru.titov.taskmanagerserver.dto.response.UserListResponse;
...
public class UserEndpoint {
    ...
    public Response changePassword(
            ...
            @WebParam(name = "newPassword", partName = "newPassword") String newPassword
    ) {
