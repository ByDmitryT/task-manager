 ...
 * 2019-01-15T19:34:42.799+03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "UserEndpointService",
                  wsdlLocation = "http://localhost:8080/UserEndpoint?wsdl",
                  targetNamespace = "http://endpoint.taskmanagerserver.titov.ru/")
public class UserEndpointService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://endpoint.taskmanagerserver.titov.ru/", "UserEndpointService");
    public final static QName UserEndpointPort = new QName("http://endpoint.taskmanagerserver.titov.ru/", "UserEndpointPort");
    static {
        URL url = null;
        try {
