 ...
 * generated in the ru.titov.taskmanagerserver.endpoint package. 
...
public class ObjectFactory {
    ...
    private final static QName _ChangePassword_QNAME = new QName("http://endpoint.taskmanagerserver.titov.ru/", "changePassword");
    private final static QName _ChangePasswordResponse_QNAME = new QName("http://endpoint.taskmanagerserver.titov.ru/", "changePasswordResponse");
    private final static QName _SignIn_QNAME = new QName("http://endpoint.taskmanagerserver.titov.ru/", "signIn");
    private final static QName _SignInResponse_QNAME = new QName("http://endpoint.taskmanagerserver.titov.ru/", "signInResponse");
    private final static QName _SignUp_QNAME = new QName("http://endpoint.taskmanagerserver.titov.ru/", "signUp");
    private final static QName _SignUpResponse_QNAME = new QName("http://endpoint.taskmanagerserver.titov.ru/", "signUpResponse");
    private final static QName _ViewAll_QNAME = new QName("http://endpoint.taskmanagerserver.titov.ru/", "viewAll");
    private final static QName _ViewAllResponse_QNAME = new QName("http://endpoint.taskmanagerserver.titov.ru/", "viewAllResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ru.titov.taskmanagerserver.endpoint
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.taskmanagerserver.titov.ru/", name = "changePassword")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.taskmanagerserver.titov.ru/", name = "changePasswordResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.taskmanagerserver.titov.ru/", name = "signIn")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.taskmanagerserver.titov.ru/", name = "signInResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.taskmanagerserver.titov.ru/", name = "signUp")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.taskmanagerserver.titov.ru/", name = "signUpResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.taskmanagerserver.titov.ru/", name = "viewAll")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.taskmanagerserver.titov.ru/", name = "viewAllResponse")
